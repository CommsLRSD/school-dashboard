...
require_once LRSD_SF_PLUGIN_DIR . 'includes/card-creator.php';
...
require_once LRSD_SF_PLUGIN_DIR . 'admin/card-creator.php';
...
add_action('wp_ajax_lrsd_sf_update_custom_option', 'lrsd_sf_ajax_update_custom_option');
add_action('wp_ajax_lrsd_sf_delete_custom_option', 'lrsd_sf_ajax_delete_custom_option');
add_action('wp_ajax_lrsd_sf_sort_custom_options', 'lrsd_sf_ajax_sort_custom_options');
...
add_action('wp_trash_post', function ($post_id) {
    if (get_post_type($post_id) === 'lr_school') {
